<template>
  <svg
    ...
    <g id="freepik--Floor--inject-34">
      <line
        ...
        :style="
          'fill: none; stroke: ' +
          textColor +
          ';stroke-miterlimit: 10;stroke-width: 1.1133040189743042px;'
        "></line>
      <line
        x1="440.51"
        y1="380.53"
    ...
    <g id="freepik--yarn-ball--inject-34">
      <ellipse
        cx="306.07"
        cy="410.55"
        rx="30.39"
    ...
    <g id="freepik--Plants--inject-34">
      ...
      <polyline
        ...
        :style="
          'fill: none; stroke: ' +
          plantColor +
          '; stroke-linecap: round; stroke-linejoin: round; stroke-width: 1.1133040189743042px;'
        "></polyline>
      <polyline
...
const textColor = ref('#eedddd');
/** The color of the plant's stem */
const plantColor = ref('#aa9999');
/** Theme of the site, either 'dark' or 'light' */
const theme = useState('theme');
/** When the theme is changed, match the colors of the svg to achieve contrast */
watch(
  () => theme.value,
  (newTheme) => {
    if (newTheme == 'dark') {
      textColor.value = '#eedddd';
      plantColor.value = '#aa9999';
    } else {
      textColor.value = '#263238';
      plantColor.value = '#263238';
    }
  },
  { immediate: true }
);
